...
export const metadata: Metadata = {
  ...
  description:
    'Explore high-resolution PC & mobile wallpapers. Filter by 16:9 Desktop landscape or 9:16 AMOLED Mobile portrait ratios with instant 1-click batch ZIP pack downloads.',
  keywords: [
    'browse wallpapers',
  ...
  openGraph: {
    title: 'Browse High-Res Gaming Wallpapers | Wall-the-Heaven',
